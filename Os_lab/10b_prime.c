...
sem4e1@ubuntu:~/01JST22UCS010/OS/7$ cc parent.c -lrt

sem4e1@ubuntu:~/01JST22UCS010/05/7$ cc child.c -lrt -lm

sem4e1@ubuntu:~/01JST22UCS010/OS/7$ ./a.out 2 20

CHILD:

The prime numbers in the range 2 and 20 are:
...
sem4e1@ubuntu:~/01JST22UCS010/05/7$